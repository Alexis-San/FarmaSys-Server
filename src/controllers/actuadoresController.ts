...
import { obtenerActuadores, obtenerActuadorPorId, crearActuador, actualizarActuador, eliminarActuador } from '../services/actuadorService';
...
export const deleteActuador = async (req: Request, res: Response) => {
    try {
        await eliminarActuador(req.params.id);
